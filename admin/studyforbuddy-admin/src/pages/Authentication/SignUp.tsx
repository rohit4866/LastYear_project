...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${BASE_URL}/professors/create`, {
        method: 'POST',
        body: data
      });
      ...
      if (response.ok) {
        navigate('/auth/signin', { state: { successMessage: 'Account created successfully' } });
      } else {
        // Display the error from the server response if present
        setSnackbar({
          open: true,
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <div className="flex items-center justify-center">
                ...
                <h1 className="text-xl font-bold">StudyForBuddy</h1>
              </div>
              <p className="2xl:px-20">
                Sigun up with StudyForBuddy and get opportunities.
              </p>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    />
                    <FiUser className="absolute right-4 top-4 text-[#B1B9C5]" size={22} />
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                    <SlEnvolope className="absolute right-4 top-4 text-[#B1B9C5]" size={22} />
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                    <FiPhone className="absolute right-4 top-4 text-[#B1B9C5]" size={22} />
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                    <SlLock className="absolute right-4 top-4 text-[#B1B9C5]" size={22} />
                  </div>
                </div>
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg bg-[#4A6E8A] p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
              </form>
